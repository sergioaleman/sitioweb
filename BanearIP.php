<?php
    ...
    if ($_SESSION["AvisoDeBaneado"] == 1) {
        ...
        <h1>Atenci&oacute;n! has realizado una actividad no permitida, si lo vuelves a intentar ser&aacute;s baneado.</h1>
        </body></html>";
    }
    else {
        if (BanearIP() == TRUE) {
            ...
            echo "<html><body>
            <h1>IP ".$_SERVER['REMOTE_ADDR']." BANEADA que tengas un buen d&iacute;a.</h1>
            </body></html>";        
        }
    }
